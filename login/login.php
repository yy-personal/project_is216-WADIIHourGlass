    ...
    <div class="mt-3 text-white ">
        <div class="container d-flex align-items-center flex-column">
            ...
            <div id="app" class="container ">
                <!-- row -->
                <div class="row">
                    <div class="col-12 col-sm-10 col-md-8 mx-auto bg-light rounded-3 p-1 p-sm-5">
                        ...
                        <form>
                            <div class="row w-90 w-sm-75 py-2 mx-auto">
                                <div class="form-group ">
                                    <label for="inputUsername" class="text-black my-3">Email:</label>
                                    <input type="text" class="form-control" id="inputUsername" placeholder="Email"
                                        v-on:keyup.enter="checkLogin" v-model="logDetails.email">
                                </div>
                            </div>
                            <div class="row w-90 w-sm-75 py-2 mx-auto">
                                <div class="form-group ">
                                    ...
                                    <input type="password" class="form-control" id="inputPassword"
                                        placeholder="Password" v-model="logDetails.password"
                                        v-on:keyup.enter="checkLogin">
                                </div>
                            </div>
                            <div class="row w-90 w-sm-75 py-2 mx-auto">
                                <div class="col-12 col-sm-6 py-2 form-group">
                                    <a class="w-100 btn btn-primary btn-block" @click="checkLogin()">Login</a>
                                </div>
                                <div class="col-12 col-sm-6 py-2 form-group">
                                    <a href="register.php" class="w-100 btn btn-secondary btn-block">Create Account</a>
                                </div>
                            </div>
